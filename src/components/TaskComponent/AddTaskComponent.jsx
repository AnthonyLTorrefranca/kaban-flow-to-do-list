...
export default function AddTaskComponent({taskName, handleChange,handleCancel, handleSubmit, alert, inputRef}) {
  return (
    <form onSubmit={handleSubmit} className="flex flex-col justify-center items-center h-screen z-50 bg-gray-500">
        ...
        {alert === "edit" && <input type="text" ref={inputRef} className="border p-5 rounded-3xl text-black" placeholder="Enter your task here..." name="taskName" value={taskName} onChange={(e)=> handleChange(e)} /> } 
